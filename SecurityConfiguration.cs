...
namespace Owasp.Esapi
{
  ...
  [ProgId("Owasp_Esapi.SecurityConfiguration")]
    public class SecurityConfiguration : Component, ISecurityConfiguration
    {
        /// <summary> 
        /// The master password.
        /// </summary>
        ...
        public IDictionary regexMap = null;
        ...
        public const string ALLOWED_LOGIN_ATTEMPTS = "AllowedLoginAttempts";

        public const string MASTER_PASSWORD = "MasterPassword";

        public const string MASTER_SALT = "MasterSalt";

        public const string VALID_EXTENSIONS = "ValidExtensions";

        public const string MAX_UPLOAD_FILE_BYTES = "MaxUploadFileBytes";

        public const string USERNAME_PARAMETER_NAME = "UsernameParameterName";

        public const string PASSWORD_PARAMETER_NAME = "PasswordParameterName";

        public const string MAX_OLD_PASSWORD_HASHES = "MaxOldPasswordHashes";

        public const string ENCRYPTION_ALGORITHM = "EncryptionAlgorithm";

        public const string HASH_ALGORITHM = "HashAlgorithm";

        public const string CHARACTER_ENCODING = "CharacterEncoding";

        public const string RANDOM_ALGORITHM = "RandomAlgorithm";

        public const string DIGITAL_SIGNATURE_ALGORITHM = "DigitalSignatureAlgorithm";

        public const string RESPONSE_CONTENT_TYPE = "ResponseContentType";

        public const string REMEMBER_TOKEN_DURATION = "RememberTokenDuration";

        public const string LOG_LEVEL = "LogLevel";

        
        // FIXME: Update to standard pattern
        public const int MAX_REDIRECT_LOCATION = 1000;
    
        public const int MAX_FILE_NAME_LENGTH = 1000;
