...
namespace Owasp.Esapi
{
  ...
  [ProgId("Owasp_Esapi.Encoder")]
    public class Encoder: Component, IEncoder
    {
        static Encoder()
		{
        ...
        /// <summary> Encode String for base64.
        /// [p]
        /// Beware double-encoding, as this will corrupt the results and could
        /// possibly cause a downstream security mechansim to make a mistake.
        /// 
        ...
        /// <returns> The encoded string.
        /// </returns> 
        /// <seealso cref="Owasp.Esapi.Interfaces.IEncoder.EncodeStringForBase64(string, bool)">
        /// </seealso>
        public string EncodeStringForBase64(string input, bool wrap)
        {            
            System.Text.ASCIIEncoding encoding = new System.Text.ASCIIEncoding();
            byte[] binput = encoding.GetBytes(input);
            string b64 = Convert.ToBase64String(binput);            
            if (!wrap)
            {
                b64 = b64.Replace("\r", "").Replace("\n", "");
            }
        ...
        /// </returns>
        /// <seealso cref="Owasp.Esapi.Interfaces.IEncoder.DecodeStringFromBase64(string)">
        /// </seealso>
        public string DecodeStringFromBase64(string input)
        {
            byte[] boutput = Convert.FromBase64String(input);
            System.Text.ASCIIEncoding encoding = new System.Text.ASCIIEncoding();
            byte[] binput = encoding.GetBytes(input);
