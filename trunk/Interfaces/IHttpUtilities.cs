...
namespace Owasp.Esapi.Interfaces
{
    ...
    public interface IHttpUtilities
    {
        ...
        /// </param>
        string GetSafeCookie(string name, string value, int maxAge, string domain, string path);
        ...
        /// <param name="value">The value of the cookie.
        /// </param>
        string GetSafeHeader(string name, string value);
        ...
        /// </param>
        /// <returns>location string, if valid</returns>
        string GetSafeRedirect(string context, string location);
