...
namespace Owasp.Esapi
{
  ...
  [ProgId("Owasp_Esapi.HttpUtilities")]      
    public class HttpUtilities : Component, IHttpUtilities
    {
        ...
        /// </param>
        /// <returns>cookie header string</returns>
        /// <seealso cref="Owasp.Esapi.Interfaces.IHttpUtilities.GetSafeCookie(string, string, int, string, string)">
		/// </seealso>
        public string GetSafeCookie(string name, string cookieValue, int maxAge, string domain, string path)
		{
        ...
        /// </seealso>
        public string GetSafeHeader(string name, string val)
		{
        ...
        /// </param>
        /// <returns>redirect location, if valid</returns>
        /// <seealso cref="Owasp.Esapi.Interfaces.IHttpUtilities.GetSafeRedirect(string, string)">
        /// </seealso>
		public string GetSafeRedirect(string context, string location)
		{
            if (!Esapi.Validator().IsValidRedirectLocation(context, location, false))
			{
				throw new ValidationException("Bad Redirect string", "Bad redirect location: " + location);
			}			
			return (location);
		}
		...
		{
			return ((SecurityConfiguration) Esapi.SecurityConfiguration()).ResponseContentType;
		}
