...
namespace Owasp.Esapi
{
  ...
  [ProgId("Owasp_Esapi.EncryptedProperties")]      
    public class EncryptedProperties : Component, IEncryptedProperties, IXmlSerializable
    {
        ...
        /// <summary> Store the encrypted properties to a file.        
        /// </summary>
        /// <param name="outStream">The file path to store the properties to.
        /// </param>
        /// <param name="comments">The comments to store with the properties file.        
        /// </param>
        public virtual void StoreInFile(string filePath, string comments)
        {
