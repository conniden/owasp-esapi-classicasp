...
namespace Owasp.Esapi
{
    ...
    [ProgId("Owasp_Esapi.AccessReferenceMap")]
    public class AccessReferenceMap: Component, IAccessReferenceMap
    {
		...
		public Hashtable itod = new Hashtable();
		
		/// <summary>The dtoi. </summary>
		
		public Hashtable dtoi = new Hashtable();
