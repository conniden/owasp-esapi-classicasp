...
namespace Owasp.Esapi {
  ...
  [ProgId("Owasp_Esapi.Validator")]
  public class Validator : Component, IValidator {
    ...
    /// </seealso>
    public DateTime GetValidDate(string context, string input, bool allowNull) {
      try {
    ...
    /// </seealso>
    public bool IsValidDate(String context, String input, bool allowNull) {
      try {
        GetValidDate(context, input, allowNull);
        return true;
      } catch (Exception e) {
        return false;
      }
...
*/
    ...
    public String GetValidPrintable(String context, String input, int maxLength, bool allowNull) {
      ...
      try {
        ...
        GetValidPrintable(context, canonical, maxLength, allowNull);
      } catch (EncodingException ee) {
    ...
    /// <param name="input">Input value</param>
    /// <returns>Boolean value inidicating whether or not data is valid</returns>
    private static bool IsEmptyBytes(byte[] input) {
