...
namespace Owasp.Esapi
{
  ...
  [ProgId("Owasp_Esapi.Logger")]
    public class Logger : Component, ILogger
    {
        ...
        public void LogInFile(string messsage)
        {
            TextWriter tw = new StreamWriter(@"C:\Users\Juan Carlos\Desktop\OWASP\Classic ASP\owasp-esapi-NETAndClassicASP\Owasp.Esapi\resources\log.txt", true);

            // write a line of text to the file
            tw.WriteLine(DateTime.Now.ToShortTimeString() + ":" + messsage);
